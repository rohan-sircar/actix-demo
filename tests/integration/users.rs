...
mod tests {
    ...
    mod avatar_api {
        ...
        static PNG_IMAGE: &[u8] = &[
            ...
            0x00, 0x0A, 0x49, 0x44, 0x41, // IDAT
            0x54, 0x78, 0x9C, 0x63, 0x00, 0x01, 0x00, 0x00, 0x05, 0x00, 0x01,
            0x0D, 0x0A, 0x2D, 0xB4, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E,
            0x44, 0xAE, // IEND
            0x42, 0x60, 0x82,
        ];
        ...
        async fn should_return_unauthorized_without_token() {
            ...
            let mut resp =
                ctx.test_server.delete("/api/avatars").send().await.unwrap();
