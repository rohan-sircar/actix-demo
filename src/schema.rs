...
diesel::joinable!(pet_activities -> pet_basic_info (pet_basic_info_id));
diesel::joinable!(pet_adoption_details -> pet_basic_info (pet_basic_info_id));
diesel::joinable!(pet_basic_info -> users (user_id));
diesel::joinable!(pet_location_owner -> pet_basic_info (pet_basic_info_id));
diesel::joinable!(pet_personality_traits -> pet_basic_info (pet_basic_info_id));
diesel::joinable!(pet_profile_images -> pet_basic_info (pet_basic_info_id));
